...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bButton1.setOnClickListene(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                Intent pindah = new Intent(MainActivity.this, Main2Activity.class);
                pindah.putExtra("tempatMakan", "Eatbus");
                pindah.putExtra("menu", ACCESSIBILITY_SERVICE.toString());
                pindah.putExtra("jumlahpesanan", ACCESSIBILITY_SERVICE.toString());
